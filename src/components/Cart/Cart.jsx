...
const Cart = ({ cart, handleEmptyCart, handleRemoveFromCart, handleUpdateCartQty }) => {
    ...
    const EmptyCart= () =>(
        ...
        <Link to='/' className={classes.link}>Start addind some</Link>
        </Typography>
        );
        ...
        const FilledCart = () => (
            ...
            <div className={classes.cardDetails}>
                    ...
                    <div>
                        ...
                        <Button component={Link} to="/checkout" className={classes.checloutButton} size="large" type="button" variant="contained" color="primary">Checkout</Button>
                    </div>
            </div>
            </>
        );
